// ua: Сервіс для роботи з воркспейсами: створення, отримання, оновлення та видалення.

// Використовує транзакції для забезпечення цілісності даних при створенні воркспейсу
// та призначенні ролі власника.
